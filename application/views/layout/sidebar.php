    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="<?php echo base_url('index.php/wisata/index')?>" class="nav-link">
              <i class="nav-icon fas fa-th"></i>
              <p>
                Wisata
                <span class="right badge badge-danger">New</span>
        ...
        <a href="<?php echo site_url('home/index') ?>" class="btn btn-outline-info" style="width: 100%;">Log-out</a>
      </nav>
      <!-- /.sidebar-menu -->
    </div>
    <!-- /.sidebar -->
